...
export function register(r) {
  r.get('/health', async ({ env }) => ({
    ...
    integrations: {
      ...
      saleChecks: !!(env.SALE_CHECK_QUEUE && webhookConfigured(env) && squareConfigured(env) && (!env.INVENTORY_COORDINATOR || env.LISTING_CHECKS_ENABLED === 'true')),
      listingChecks: env.LISTING_CHECKS_ENABLED === 'true' && !!env.INVENTORY_COORDINATOR,
