  ...
  TL.floorplan = (function(){
    ...
    function backdrop(room){
      ...
      (v.aisles||[]).forEach(function(a){out+='<rect class="fp-aisle fp-aisle-'+(a.access==='vendor'?'vendor':'customer')+'" x="'+(a.c-1)+'" y="'+(a.r-1)+'" width="'+a.w+'" height="'+a.h+'"/><text class="fp-aisle-label" x="'+(a.labelC===undefined?a.c+a.w/2-1:a.labelC)+'" y="'+(a.r+a.h/2)+'" text-anchor="middle">'+esc(a.label)+'</text>';});
      ...
      var firstDoor=v.doors[0],routeEnd=firstDoor.c+firstDoor.w/2-1;
      out+='<path class="fp-route" d="M215 41V49H'+routeEnd+' M132 49V29"/><path class="fp-route-arrow" d="m211 45 4 4 4-4 m-90-12 3-4 3 4"/>';
      ...
      var coffee=v.obstacles.find(function(a){return a.type==='coffee';});
      if(coffee)out+='<text class="fp-room-label" x="'+(coffee.c-8)+'" y="81">CHAIRS + COFFEE TABLE</text>';
